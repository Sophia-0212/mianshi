...
- [1. 预备知识](#预备知识)
  - [1.1 实例对象与函数对象](#11-实例对象与函数对象)
  - [1.2 两种类型的回调函数](#12-两种类型的回调函数)
    - [1. 同步回调](#1-同步回调)
    - [2. 异步回调](#2-异步回调)
  - [1.3 JS中的异常error处理](#13-js中的异常error处理)
    - [1. 错误的类型](#1-错误的类型)
    - [2. 错误处理（捕获与抛出）](#2-错误处理捕获与抛出)
    - [3. 错误对象](#3-错误对象)
- [2. Promise的理解和使用](#2promise的理解和使用)
  - [2.1 Promise是什么](#21-promise是什么)
    - [1. 理解Promise](#1理解promise)
    - [2. Promise 的状态](#2promise-的状态)
    - [3. Promise对象的值](#3-promise对象的值)
    - [4. Promise 的基本使用](#4-promise-的基本使用)
  - [2.2 为什么要用 Promise](#22-为什么要用-promise)
    - [1. 指定回调函数的方式更加灵活](#1指定回调函数的方式更加灵活)
    - [2. 支持链式调用，可以解决回调地狱问题](#22-为什么要用-promise)
      - [回调地狱的缺点？](#回调地狱的缺点)
      - [解决方案？](#解决方案)
      - [终极解决方案？](#终极解决方案)
  - [2.3 如何使用 Promise](#23-如何使用-promise)
    - [1. Promise.reject 方法](#1-promisereject-方法promiseresolvereason)
    - [2. Promise.all 方法](#2promiseall-方法promisealliterable)
    - [3. Promise.race 方法](#3promiserace方法promiseraceiterable)
- [3. Promise 的几个关键问题](#3promise-的几个关键问题)
  - [1. 如何改变 promise 的状态？](#1如何改变-promise-的状态)
  - [2. 一个 promise 指定多个成功/失败回调函数，都会调用吗？](#2-一个-promise-指定多个成功失败回调函数都会调用吗)
  - [3. 改变 promise 状态和指定回调函数谁先谁后？](#3-改变-promise-状态和指定回调函数谁先谁后)
  - [4. promise.then() 返回的新 promise 的结果状态由什么决定？](#4-promisethen-返回的新-promise-的结果状态由什么决定)
  - [5. promise 如何串联多个操作任务？](#5promise-如何串联多个操作任务)
  - [6. Promise 异常穿透(传透)？](#6promise-异常穿透传透)
  - [7. 中断 promise 链？](#7中断-promise-链)
