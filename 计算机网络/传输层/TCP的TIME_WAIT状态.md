...
![TIME_WAIT 与 CLOSE_WAIT 问题的排查流程](../img/tcp-time-wait-close-wait-troubleshooting-flowchart.png)
...
ss -ltn
```
![macOS：查看各 TCP 状态数量和 TIME-WAIT 主要集中在哪些远端](../img/macos-check-tcp-state-count-and-time-wait-remote-distribution.png)
