...
![端口什么情况下会冲突](../img/when-does-tcp-conflict-occur.png)
...
![DNS 和 HTTP/3 同时使用 TCP 与 UDP 端口的实际案例](../img/can-tcp-and-udp-use-the-same-port-practical-application-example.png)
...
![HTTP/3 协议栈实现](../img/http-3-implementation.png)
...
> 来源: https://javaguide.cn/cs-basics/network/can-tcp-and-udp-use-the-same-port.html
