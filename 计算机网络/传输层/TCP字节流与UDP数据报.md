...
![TCP 与 UDP 的消息边界](../img/tcp-udp-byte-stream-tcp-udp-message-boundary.png)
...
客户端等待服务端响应
```
![Nagle + Delayed ACK 为什么可能让小包变慢？](../img/tcp-udp-byte-stream-nagle-delayed-ack-latency.png)
