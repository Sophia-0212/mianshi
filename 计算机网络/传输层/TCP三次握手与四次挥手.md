...
![TCP 三次握手图解](../img/tcp-shakes-hands-three-times.png)
...
![TCP 四次挥手图解](../img/tcp-waves-four-times.png)
...
![TCP 连接建立与关闭的常见状态迁移路径](../img/tcp-state-diagram.png)
...
这部分内容已单独成文，详见 [TCP TIME_WAIT 详解：为什么要等、会不会出问题、能不能复用？](/cs-basics/network/tcp-time-wait.html)。
