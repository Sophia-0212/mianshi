...
![TCP/IP 四层模型中 HTTP 与 TCP 所在层次](../img/tcp-ip-4-model.png)
...
![HTTP：超文本传输协议概览](../img/http-overview.png)
...
![不同 HTTP 版本里，Keep-Alive 的默认行为不一样](../img/different-http-versions-have-different-default-keep-alive-behaviors.png)
...
![TCP Keepalive 工作原理](../img/tcp-keepalive-vs-http-keepalive-tcp-keepalive-working-principle.png)
...
![Mac 下查看 TCP Keepalive 参数](../img/tcp-keepalive-parameters.jpg)
...
![TCP Keepalive 探测机制](../img/tcp-keepalive-vs-http-keepalive-tcp-keepalive-detection-mechanism.png)
...
> 来源: https://javaguide.cn/cs-basics/network/tcp-keepalive-vs-http-keepalive.html
