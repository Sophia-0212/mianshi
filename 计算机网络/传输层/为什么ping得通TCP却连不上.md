...
![ICMP 和 TCP 位于 TCP/IP 协议栈的不同层次](../img/tcp-ip-4-model.png)
...
![TLS 1.2 ECDHE 握手流程](../img/https-rsa-ecdhe-tls-1-2-ecdhe-rsa-handshake-process.png)
...
![HTTPS连接排查层次](../img/can-ping-but-tcp-may-not-connect-https-connection-troubleshooting-layers.png)

> 来源: https://javaguide.cn/cs-basics/network/can-ping-but-tcp-may-not-connect.html
