...
![TCP 粘包 / 拆包为什么会出现？](../img/tcp-udp-byte-stream-tcp-sticky-split-causes.png)
...
![ARQ 与 TCP 重传机制的关系](../img/tcp-reliability-guarantee-arq-retransmission-model.png)
...
![RTO 超时时间的计算流程](../img/tcp-reliability-guarantee-rto-calculation-flow.png)
...
![TCP 零窗口探测机制](../img/tcp-reliability-guarantee-zero-window-probe.png)
...
![TCP发送窗口结构](../img/tcp-send-window.png)
...
![TCP接收窗口结构](../img/tcp-receive-window.png)
...
![SWS、Nagle 算法与延迟 ACK 的关系](../img/tcp-reliability-guarantee-sws-nagle-delayed-ack.png)
...
![TCP的拥塞控制](../img/tcp-congestion-control.png)
...
3. TCP and UDP Tutorial：[https://www.9tut.com/tcp-and-udp-tutorial](https://www.9tut.com/tcp-and-udp-tutorial)

4. Computer Network：[https://github.com/wolverinn/Waking-Up/blob/master/Computer Network.md](https://github.com/wolverinn/Waking-Up/blob/master/Computer%20Network.md)
...
7. TCP 之滑动窗口原理：[https://cloud.tencent.com/developer/article/1857363](https://cloud.tencent.com/developer/article/1857363)

8. RFC 9293 - Transmission Control Protocol：[https://www.rfc-editor.org/rfc/rfc9293](https://www.rfc-editor.org/rfc/rfc9293)

9. RFC 6928 - Increasing TCP's Initial Window：[https://www.rfc-editor.org/rfc/rfc6928](https://www.rfc-editor.org/rfc/rfc6928)

10. RFC 5681 - TCP Congestion Control：[https://datatracker.ietf.org/doc/html/rfc5681](https://datatracker.ietf.org/doc/html/rfc5681)

11. RFC 2018 - TCP Selective Acknowledgment Options：[https://www.rfc-editor.org/rfc/rfc2018](https://www.rfc-editor.org/rfc/rfc2018)

12. RFC 2883 - An Extension to the Selective Acknowledgement（SACK） Option for TCP：[https://www.rfc-editor.org/rfc/rfc2883](https://www.rfc-editor.org/rfc/rfc2883)

13. RFC 9438 - CUBIC for Fast and Long-Distance Networks：[https://www.rfc-editor.org/rfc/rfc9438](https://www.rfc-editor.org/rfc/rfc9438)

14. RFC 8257 - Data Center TCP（DCTCP）：[https://www.rfc-editor.org/rfc/rfc8257](https://www.rfc-editor.org/rfc/rfc8257)

15. BBR: Congestion-Based Congestion Control, ACM Queue, 2016：[https://queue.acm.org/detail.cfm?id=3022184](https://queue.acm.org/detail.cfm?id=3022184)

16. RFC 1122 - Requirements for Internet Hosts - Communication Layers：[https://datatracker.ietf.org/doc/html/rfc1122](https://datatracker.ietf.org/doc/html/rfc1122)

17. RFC 6298 - Computing TCP's Retransmission Timer：[https://www.rfc-editor.org/rfc/rfc6298](https://www.rfc-editor.org/rfc/rfc6298)

18. RFC 7323 - TCP Extensions for High Performance：[https://datatracker.ietf.org/doc/rfc7323/](https://datatracker.ietf.org/doc/rfc7323/)
